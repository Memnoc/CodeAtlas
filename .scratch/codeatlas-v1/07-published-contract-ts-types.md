...
- [x] The generated JSON Schema is committed at a documented path with a
      semver version, and a short doc states the versioning/breaking-change
      policy
- [x] TypeScript types are generated from the schema; the dashboard package
      consumes only these generated types
- [x] CI regenerates schema and TS types and fails on any diff against the
      committed artifacts
- [x] A contract test validates a known-good fixture map against the
